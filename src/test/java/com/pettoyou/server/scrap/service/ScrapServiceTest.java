...
//
//        // when
//        ScrapRegistRespDto result = scrapService.registScrap(hospital.getStoreId(), member.getMemberId());
//
//        // then
...
//                .isThrownBy(() -> scrapService.registScrap(1L, 1L))
...
//
//        // when
//        scrapService.cancelScrap(scrap.getScrapId(), member.getMemberId());
//
//        // then
...
//        assertThatExceptionOfType(CustomException.class)
//                // when
//                .isThrownBy(() -> scrapService.cancelScrap(1L, 1L))
...
//        assertThatExceptionOfType(CustomException.class)
//                // when
//                .isThrownBy(() -> scrapService.cancelScrap(scrap.getScrapId(), wrongMemberId))
